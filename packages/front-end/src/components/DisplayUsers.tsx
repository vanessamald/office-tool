        ...
        <tbody key={user.id}>
            <tr>
                ...
                <td>
                    ...
                    <>
                    <div>
                        <div  id="dropdownDotsHorizontal" className="w-20 z-10 bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 absolute" >
                            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownMenuIconHorizontalButton">
                                <li className='dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-600'>
                                    <button 
