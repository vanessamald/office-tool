                ...
                <table className='table-auto w-full'>
                    <thead>
                        <tr className='border-t'>
                            <th className='p-2 text-left text-black sm:inline-block hidden'>User Id</th>
                            <th className='p-2 text-left text-black'>First Name</th>
                            <th className='p-2 text-left text-black'>Last Name</th>
                            <th className='p-2 text-left text-black sm:inline-block hidden'>Email</th>
                        </tr>
                    </thead>
